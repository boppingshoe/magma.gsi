...
$\sqrt{\frac{1}{n}\sum_{i = 1}^{n}\left( Y_{i} - {\widehat{Y}}_{i} \right)^{2}}$,
...
$i$^(th) analysis. Mean bias was the mean of the differences between the
...
run MAGMA using hybrid conditional GSI algorithm[¹](#fn1).
